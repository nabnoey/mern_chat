      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            {/* button */}
            <button className="btn w-full bg-orange-500 hover:bg-orange-600 border-none text-white mt-2" onClick={()=>navigate("/contact")}>
              Sign in
            </button>
            ...
            <p className="text-center text-sm text-gray-400 mt-4">
              ...
              <span className="text-orange-400 cursor-pointer hover:underline" onClick={()=>navigate("/")}>
                Create Account
              </span>
            </p>
          </div>
